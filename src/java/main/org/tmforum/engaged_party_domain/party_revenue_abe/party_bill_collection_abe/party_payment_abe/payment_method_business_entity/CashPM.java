...
/**
* CashPM is an example of  payment method, through which payment can be  
* made by cash. 
...
public  class CashPM extends PaymentMethod {



/**  
* Field cashierInfo
* A description of the employee who received the cash for payment 
