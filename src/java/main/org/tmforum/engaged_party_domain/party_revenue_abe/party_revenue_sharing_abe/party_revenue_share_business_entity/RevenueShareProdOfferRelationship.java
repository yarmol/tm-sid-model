...
/**
* A relationship between two PartyRevenueShareProdOffers. For example, a 
* fter shares are reconciled a new PartyRevenueShareProdOffer may be det 
* ermined that replaces the original share that was determined. 
 @since SID_R16.5
*/ 

public  class RevenueShareProdOfferRelationship  {
...
/**  
* Field partyRevenueShareProdOffer1
*/
protected PartyRevenueShareProdOffer partyRevenueShareProdOffer1 ;
