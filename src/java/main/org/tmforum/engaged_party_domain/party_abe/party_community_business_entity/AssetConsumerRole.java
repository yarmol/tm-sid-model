...
/**
* An AssetConsumerRole is a BusinessInteractionRole a party (identified  
* by a CommunityMember) plays when consuming assets from a Community. 

Inheritance tree: |- 
 SID Models::Common Business Entities Domain::Business Interaction ABE::BusinessInteractionRole @since SID_R16.5
*/ 

public  class AssetConsumerRole extends BusinessInteractionRole {
