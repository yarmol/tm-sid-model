...
/**
* A ContributionProviderRole is a BusinessInteractionRole a party (ident 
* ified by a CommunityMember) plays when contributing to a Community. 

Inheritance tree: |- 
 SID Models::Common Business Entities Domain::Business Interaction ABE::BusinessInteractionRole @since SID_R16.5
*/ 

public  class ContributionProviderRole extends BusinessInteractionRole {
