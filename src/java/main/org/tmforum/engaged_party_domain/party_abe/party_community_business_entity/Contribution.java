...
/**
* A Contribution is a BusinessInteraction, containing items, associated  
* to Resource, Service or Product that is contributed to a Community by  
* a CommunityMember. 
...
public  class Contribution extends BusinessInteraction {
