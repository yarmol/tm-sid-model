...
/**
* A PartyRole a Party plays, who imposed a Supplier to provide a deliver 
* able by a formal Agreement (Commitment). 

Inheritance tree: |- 
 SID Models::Engaged Party Domain::Party ABE::PartyRole @since SID_R16.5
*/ 

public  class Buyer extends PartyRole {
...
*/
protected CommitmentProcurementRole commitmentProcurementRole ;
