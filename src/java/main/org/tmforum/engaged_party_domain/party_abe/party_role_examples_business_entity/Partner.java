...
/**
* A PartyRole, played by a Party being an equitable partner in a busines 
* s interaction with other parties, playing the Partner role. Usually al 
* l Partner have the same (or even compatible) business objectives. 

Inheritance tree: |- 
 SID Models::Engaged Party Domain::Party ABE::PartyRole @since SID_R16.5
*/ 

public  class Partner extends PartyRole {
