...
/**
* An individual who possesses specific technical training and competence 
*  in a specific area, such as digital services. 

Inheritance tree: |- 
 SID Models::Engaged Party Domain::Party ABE::PartyRole @since SID_R16.5
*/ 

public  class Technician extends PartyRole {
