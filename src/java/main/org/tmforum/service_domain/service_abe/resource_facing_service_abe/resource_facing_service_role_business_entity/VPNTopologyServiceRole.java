...
/**
* This class defines the specific type of topology that is required to i 
...
* cs necessary to build a VPNTopologyService, abstracted in terms of Ser 
* viceRoles. 
...
public  class VPNTopologyServiceRole extends ResourceFacingServiceRole,ServiceRole,Role,RootEntity {
