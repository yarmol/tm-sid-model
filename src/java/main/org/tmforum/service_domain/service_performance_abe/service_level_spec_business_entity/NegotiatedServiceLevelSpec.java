...
/**
* A negotiated set of service level objectives, and consequences that oc 
* cur, if the objectives are not met. 

Inheritance tree: |- 
 <a title="SID Models::Service Domain::Service Performance ABE::Service Level Spec ABE::ServiceLevelSpecification" href="_3E3F0EC000E93D40107C02B4-content.html">SID Models::Service Domain::Service Performance ABE::Service Level Spec ABE::ServiceLevelSpecification</a> @since SID_R16.5
*/ 

public  class NegotiatedServiceLevelSpec extends ServiceLevelSpecification {
