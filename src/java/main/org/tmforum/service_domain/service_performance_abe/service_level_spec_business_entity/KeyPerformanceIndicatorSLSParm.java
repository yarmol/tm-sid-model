...
/**
* A measure of a specific aspect of the performance of a ServiceResource 
*  (network or non-network) or a group of ServiceResources of the same t 
* ype. 
...
public  class KeyPerformanceIndicatorSLSParm extends ServiceLevelSpecParameter {
