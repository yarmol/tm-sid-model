...
/**
* A rate where there are different charges for different types of events 
* . This could include plans, which have different prices for evening mi 
* nutes and anytime minutes. This usage aggregates a number of simple us 
* ages. 
...
public  class TariffUsageProdOfferPriceCharge extends ProdOfferPriceCharge,ComponentProdOfferPrice,ProductOfferingPrice {
