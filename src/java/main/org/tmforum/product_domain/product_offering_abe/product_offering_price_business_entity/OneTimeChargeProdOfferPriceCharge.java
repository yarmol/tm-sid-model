...
/**
* A one time charge is levied once. An example is the cost of a cell pho 
* ne handset. 
...
public  class OneTimeChargeProdOfferPriceCharge extends ProdOfferPriceCharge,ComponentProdOfferPrice,ProductOfferingPrice {
