...
/**
* A price charged in lieu of another price. For example, purchasing two  
* of a single product offering may result in a discounted price for both 
* . 
...
public  class AlternateProdOfferPriceCharge extends ProdOfferPriceCharge,ComponentProdOfferPrice,ProductOfferingPrice {
