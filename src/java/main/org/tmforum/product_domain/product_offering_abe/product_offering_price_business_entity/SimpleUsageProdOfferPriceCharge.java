...
/**
* A rate where the charge is the same for all events. A 10 cents a minut 
* e for long distance plan is one example. 
...
public  class SimpleUsageProdOfferPriceCharge extends ProdOfferPriceCharge,ComponentProdOfferPrice,ProductOfferingPrice {
