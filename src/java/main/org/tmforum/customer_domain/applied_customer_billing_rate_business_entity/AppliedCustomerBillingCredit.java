...
/**
* A credit assigned to the customer's account in the course or for the p 
* urpose of the billing process 
...
public abstract class AppliedCustomerBillingCredit extends AtomicAppliedCustomerBillingRate,AppliedCustomerBillingRate {
...
*/
protected CustomerDisputedAmount customerDisputedAmount ;
