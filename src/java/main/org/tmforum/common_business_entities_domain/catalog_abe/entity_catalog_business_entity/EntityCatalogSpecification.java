...
/**
* A set of basic facts that defines, or specifies, what an EntityCatalog 
*  is, such as its name, description, and so forth. 

Inheritance tree: |- 
 SID Models::Common Business Entities Domain::Catalog ABE::CatalogSpecification @since SID_R16.5
*/ 

public  class EntityCatalogSpecification extends CatalogSpecification {
