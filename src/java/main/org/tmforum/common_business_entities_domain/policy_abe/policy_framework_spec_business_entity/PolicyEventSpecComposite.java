...
* ionships) of a PolicyEventComposite entity.PolicyEventSpecComposite en 
* tities are specifications that define the invariant characteristics an 
* d behavior of a group of related PolicyEvents. These PolicyEvents can  
* be PolicyEventAtomic and/or PolicyEventComposite entities. The instanc 
* e that is represented by the PolicyEventSpecComposite entity is a name 
* d managed object. 
...
public  class PolicyEventSpecComposite extends PolicyEventSpec,EntitySpecification,RootEntity {
