...
/**
* This class represents using the IEEE 802.1q Class of Service value (wh 
* ich is three bits) as part of a condition expression. Thus, only BitSt 
* ringValue and IntegerValue classes can be used in the value portion of 
*  the condition expression with this PolicyVariable. 
...
public  class 1qCoSVariable extends VariableStandard,PolicyVariable,Policy,RootEntity {
