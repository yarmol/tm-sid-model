...
/**
* This class represents using the value of the Ethertype protocol number 
*  of Ethernet frames as part of a condition expression. Thus, only BitS 
* tringValue and IntegerValue classes can be used in the value portion o 
...
public  class EtherTypeVariable extends VariableStandard,PolicyVariable,Policy,RootEntity {
