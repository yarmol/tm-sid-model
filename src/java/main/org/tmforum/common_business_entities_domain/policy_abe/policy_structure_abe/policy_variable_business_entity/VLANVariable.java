...
/**
* This class represents using the IEEE 802.1q VLAN ID value (which is 12 
*  bits) as part of a condition expression. Thus, only BitStringValue an 
* d IntegerValue classes can be used in the value portion of the conditi 
* on expression with this PolicyVariable. 
...
public  class VLANVariable extends VariableStandard,PolicyVariable,Policy,RootEntity {
