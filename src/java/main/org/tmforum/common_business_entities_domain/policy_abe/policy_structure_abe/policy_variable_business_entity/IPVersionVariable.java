...
/**
* This class represents filtering on a particular version of the IP prot 
* ocol as part of a condition expression. Thus, only BitStringValue and  
* IntegerValue classes can be used in the value portion of the condition 
*  expression with this PolicyVariable. 
...
public  class IPVersionVariable extends VariableStandard,PolicyVariable,Policy,RootEntity {
