...
/**
* This class represents using the value of port source and/or destinatio 
* n fields as part of a condition expression. Thus, only BitStringValue  
* and IntegerValue classes can be used in the value portion of the condi 
* tion expression with this PolicyVariable. 
...
public  class PortVariable extends VariableStandard,PolicyVariable,Policy,RootEntity {
...
*/
protected Integer portDirection ;
