...
/**
* This class represents using the value of the DSCP byte as part of a co 
* ndition expression. Thus, only BitStringValue and IntegerValue classes 
*  can be used in the value portion of the condition expression with thi 
* s PolicyVariable. 
...
public  class DSCPVariable extends VariableStandard,PolicyVariable,Policy,RootEntity {
