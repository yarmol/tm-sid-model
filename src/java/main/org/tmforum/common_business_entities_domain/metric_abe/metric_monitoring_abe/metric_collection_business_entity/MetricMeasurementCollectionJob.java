...
public  class MetricMeasurementCollectionJob extends MetricMeasurementJob {



/**  
* Field outputFormat
* The file format that is used for transferring the Metric data between  
...
* The rate of collecting MetricMeasure reports.  
...
/**  
* Field metricMeasurementProductionJob
*/
protected List<MetricMeasurementProductionJob> metricMeasurementProductionJob ;
