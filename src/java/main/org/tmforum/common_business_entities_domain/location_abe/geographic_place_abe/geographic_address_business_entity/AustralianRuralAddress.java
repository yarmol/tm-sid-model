...
/**
* A type of urban property address that represents a rural Australian ad 
* dress.Note:  This is an example entity. 
...
public  class AustralianRuralAddress extends GeographicAddress,AbstractGeographicAddress,GeographicPlace,Place {
