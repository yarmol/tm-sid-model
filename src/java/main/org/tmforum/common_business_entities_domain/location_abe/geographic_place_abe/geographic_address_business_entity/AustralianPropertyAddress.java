...
/**
* A type of urban property address that represents an Australian address 
* .Note:  This is an example entity. 
...
public  class AustralianPropertyAddress extends UrbanPropertyAddress,GeographicAddress,AbstractGeographicAddress,GeographicPlace,Place {
