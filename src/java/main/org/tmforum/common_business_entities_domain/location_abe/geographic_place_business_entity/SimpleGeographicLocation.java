...
/**
* A GeographicLocation that is composed of a single element; not compoun 
* d. 
...
public  class SimpleGeographicLocation extends GeographicLocation,GeographicPlace,Place {
