...
public  class NetworkRouteSection extends GeographicLocation,GeographicPlace,Place {
...
/**  
* Field relativeElevation
* The relative height to which something is elevated above a point of re 

* ference such as the ground. 

*/
protected String relativeElevation ;
