...
/**
* The lowest level, or atomic, LocalAddress.  It may exist alone or be p 
* art of a CompoundLocalAddress. 
...
public  class SimpleLocalAddress extends LocalAddress,LocalPlace,Place {
