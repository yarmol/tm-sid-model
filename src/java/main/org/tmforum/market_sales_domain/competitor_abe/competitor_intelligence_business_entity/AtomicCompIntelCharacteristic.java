...
/**
* A type of CompIntelCharacteristic that does not have any subordinate C 
* ompIntelCharacteristics, that is, an AtomicCompIntelCharacteristic is  
* a leaf-level CompIntelCharacteristic. 
...
public  class AtomicCompIntelCharacteristic extends CompetitorIntelCharacteristic {
