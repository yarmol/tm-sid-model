...
/**
* A type of MarketSegment that does not have any subordinate MarketSegme 
* nts, that is, an AtomicMarketSegment is a leaf-level MarketSegment. 
...
public  class AtomicMarketSegment extends MarketSegment {
