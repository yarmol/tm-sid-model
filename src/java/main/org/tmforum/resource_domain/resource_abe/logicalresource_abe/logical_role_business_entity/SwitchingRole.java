...
* f traffic. By modeling these capabilities as three roles, switch funct 
* ionality is both abstracted as well as categorized, so that the differ 
* ences between forwarding traffic done by a router and forwarding traff 
* ic done by a L3 switch can be differentiated. 
...
public  class SwitchingRole extends LogicalDeviceRole,LogicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
