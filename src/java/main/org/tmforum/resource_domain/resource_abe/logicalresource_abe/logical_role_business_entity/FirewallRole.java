...
* ences between firewalling done by a router and firewalling done by a d 
* edicated firewall device can be differentiated. 
...
public  class FirewallRole extends LogicalDeviceRole,LogicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
