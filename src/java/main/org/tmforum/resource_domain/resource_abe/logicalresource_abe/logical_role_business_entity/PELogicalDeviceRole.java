...
*  role of a PE (Provider Edge) device, as used in a Product or Service. 
...
public  class PELogicalDeviceRole extends LogicalDeviceRole,LogicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
