...
* e atomic in nature (e.g., not made up of multiple distinct logical dev 
* ices that can be separately managed). 
...
public  class LogicalDeviceAtomic extends LogicalDevice,LogicalResource,Resource,Entity,RootEntity {
