...
/**
* This role defines a DeviceInterface that functions as an CoreInterface 
*  - that is, an interface in the core of the network. The objective of  
* this role is to enable the definition of Policies such that all CoreIn 
...
public  class CoreInterface extends DeviceInterfaceRole,LogicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
