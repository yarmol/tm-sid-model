...
/**
* This class represents an aggregation of NetworkAtomic and possibly Net 
* workComposite objects. Each NetworkAtomic object represents a stand-al 
* one Network; these can be combined to build larger Networks by choosin 
* g the appropriate type of NetworkComposite object to aggregate Network 
* Atomic objects. Note that a NetworkComposite object can also aggregate 
*  NetworkComposite objects. 
...
public  class NetworkComposite extends Network,ResourceCollection,CompoundResource,Resource,Entity,RootEntity {
