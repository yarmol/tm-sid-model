...
/**
* This class defines required logical features to implement the specific 
*  role of a CPE (Customer Premise Edge) device, as used in a Product or 
*  Service. 
...
public  class CPELogicalDeviceRole extends LogicalDeviceRole,LogicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
