...
/**
* This is a concrete class that defines the basic physical characteristi 
* cs of a CPE (Customer Premise Edge) device. For example, what types of 
*  line cards are needed for this device to perform its role of a CPE de 
* vice. 
...
public  class CPEPhysicalDeviceRole extends PhysicalDeviceRole,PhysicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
