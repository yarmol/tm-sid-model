...
* physical components that are used to encrypt traffic with the logical  
* capability of encrypting. 
...
public  class PhysicalEncryptionRole extends PhysicalDeviceRole,PhysicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
