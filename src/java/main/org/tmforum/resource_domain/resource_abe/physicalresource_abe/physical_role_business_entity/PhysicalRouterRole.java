...
* physical components that are used to route traffic with the logical ca 
* pability of routing traffic. 
...
public  class PhysicalRouterRole extends PhysicalDeviceRole,PhysicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
