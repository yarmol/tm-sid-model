...
/**
* This is a physical role that a device has. It enables us to correlate  
* physical components that are used to forward traffic with the logical  
* capability of forwarding traffic. 
...
public  class PhysicalSwitchRole extends PhysicalDeviceRole,PhysicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
