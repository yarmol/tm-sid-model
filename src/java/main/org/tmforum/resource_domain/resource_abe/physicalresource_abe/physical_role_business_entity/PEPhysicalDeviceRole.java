...
* cs of a PE Provider Edge) device. For example, what types of line card 
* s are needed for this device to perform its role of a PE device. 
...
public  class PEPhysicalDeviceRole extends PhysicalDeviceRole,PhysicalResourceRole,ResourceRole,EntityRole,Role,RootEntity {
