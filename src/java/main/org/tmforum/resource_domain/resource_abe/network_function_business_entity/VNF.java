...
/**
* A VNF is an implementation of a Network Function for which all the Log 
* icalResources it is being provided are hosted by VirtualResources 
...
public  class VNF extends NetworkFunction,Resource,Entity,RootEntity {
