...
/**
* A Virtualised Network Function Component (VNFC) is an internal compone 
* nt of a VNF providing a defined sub-set of that VNF's functionality. 
...
public  class VNFComponent extends NetworkFunction,Resource,Entity,RootEntity {
