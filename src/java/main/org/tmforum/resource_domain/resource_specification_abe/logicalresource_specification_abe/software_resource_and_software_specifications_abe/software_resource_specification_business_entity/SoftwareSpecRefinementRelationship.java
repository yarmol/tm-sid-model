...
/**
* A specification for an association that defines divisions of a Softwar 
* eResourceSpecification into two or more other specifications.  Or fusi 
* ons of two or more specifications into a single specification.  Or one 
*  specification can be substituted for another.   
...
public  class SoftwareSpecRefinementRelationship extends SoftwareResourceSpecRelationship {
